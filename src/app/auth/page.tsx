      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="flex-1 flex items-center justify-center bg-gray-100 px-4 py-6">
          <div className="text-center max-w-sm w-full">
            <h2 className="text-lg sm:text-xl font-semibold mb-1">Nothing to show here</h2>
        ...
        <h2 className="text-lg font-semibold mb-4">Create new board</h2>
          ...
          <input
            ...
            <div className="flex justify-end gap-2">
              <Button className="w-50 border border-gray-300" variant="ghost" onClick={() => toggleModal(false)}>
                Cancel
              </Button>
